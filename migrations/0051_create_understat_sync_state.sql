-- Independent Team and Player run/item state.
DO $$ BEGIN
...
ALTER TYPE understat_sync_run_status ADD VALUE IF NOT EXISTS 'completed';
...
ALTER TABLE public.understat_sync_runs
  ADD COLUMN IF NOT EXISTS publication_skip_reason text;
