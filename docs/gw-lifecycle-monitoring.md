...
| 9. Active match window | Live facts, player stats, H2H | `LIVE_ACTIVE` while authoritative fixtures show an unfinished started match; 30-second live polling, one-minute H2H when eligible, and active player-stat cadence |  |  |
