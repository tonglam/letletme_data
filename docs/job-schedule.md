...
| `player-market-freshness-watchdog` | `36 9 * * *` | Read-only cardinality check: the current-day complete snapshot must match the published player roster; alerts without changing `/ready` |
