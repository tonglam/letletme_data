...
- [x] **FP-09 · Battle-race counters** (C6 · M · *after FP-07*) — skip matchup on missing entry result; derive `played` like points-race; expose `skipped` count
...
|----|-----------|------|-------|
| FP-09 | 1f6eb1f | 2026-07-17 | PR #11 |
