...
export function transformPlayerStat(
  ...
  try {
    ...
    const playerStat: PlayerStat = {
      ...
      bps: rawElement.bps,
      starts: rawElement.starts ?? null,
      transfersIn: rawElement.transfers_in ?? null,
      transfersInEvent: rawElement.transfers_in_event ?? null,
      transfersOut: rawElement.transfers_out ?? null,
      transfersOutEvent: rawElement.transfers_out_event ?? null,
      influenceRank: rawElement.influence_rank ?? null,
      influenceRankType: rawElement.influence_rank_type ?? null,
      creativityRank: rawElement.creativity_rank ?? null,
      creativityRankType: rawElement.creativity_rank_type ?? null,
      threatRank: rawElement.threat_rank ?? null,
