...
export class TournamentKnockoutResultsRepository {
  ...
  async upsertBatch(results: DbTournamentKnockoutResultInsert[]): Promise<number> {
    if (results.length === 0) {
      return 0;
    }
...
export const tournamentKnockoutResultsRepository = new TournamentKnockoutResultsRepository();
