    ...
    try {
      ...
      const result = await db.execute(sql`
        SELECT 
          ...
          ps.mng_win as "mngWin",
          ps.mng_draw as "mngDraw",
          ps.mng_loss as "mngLoss",
          ps.mng_underdog_win as "mngUnderdogWin",
          ps.mng_underdog_draw as "mngUnderdogDraw",
          ps.mng_clean_sheets as "mngCleanSheets",
          ps.mng_goals_scored as "mngGoalsScored",
