...
export class TournamentPointsGroupResultsRepository {
  ...
  async upsertBatch(results: DbTournamentPointsGroupResultInsert[]): Promise<number> {
    if (results.length === 0) {
      return 0;
    }
...
export const tournamentPointsGroupResultsRepository = new TournamentPointsGroupResultsRepository();
