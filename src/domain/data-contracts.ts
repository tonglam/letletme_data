...
export const dataContractRegistry = [
  ...
  },
  {
    ...
    eligibility: 'every current-season event with finished and data_checked both true',
    queueLane: liveDataQueueName,
    ...
    integrity:
      'all finalized-event global/match/entry/league publication identities are checkpoint-correct and every required Redis item retains more than seven days',
    ...
    compensator: 'bounded per-event final retention reconcile without provider fetches',
