...
export const RawFPLElementSchema = z.object({
  ...
  cost_change_start_fall: z.number().int(),
  ...
  form: z.string(),
  dreamteam_count: z.number().int(),
  in_dreamteam: z.boolean(),
  special: z.boolean(),
  squad_number: z.number().int().nullable(),
  news: z.string(),
  news_added: z.string().nullable(),
  chance_of_playing_this_round: z.number().int().min(0).max(100).nullable(),
  chance_of_playing_next_round: z.number().int().min(0).max(100).nullable(),
  value_form: z.string(),
  value_season: z.string(),
  transfers_in: z.number().int(),
  transfers_out: z.number().int(),
  transfers_in_event: z.number().int(),
  transfers_out_event: z.number().int(),
