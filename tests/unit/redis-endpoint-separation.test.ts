...
function config(overrides: Partial<AppConfig> = {}): AppConfig {
  const base: AppConfig = {
    ...
    PRICE_CHANGE_HOT_WATCH_ENABLED: true,
    PRICE_CHANGE_SINGLE_FLIGHT_ENABLED: true,
    FPL_ADMISSION_TEST_MODE: false,
    TOURNAMENT_OFFICIAL_SYNC_DEFAULT_ENABLED: true,
    FPL_MAX_INFLIGHT: 5,
    ...
    SCHEDULER_RESOLVE_TIMEOUT_MS: 10_000,
    SCHEDULER_LEASE_MS: 15 * 60_000,
    QUEUE_LANES_V2_ENABLED: false,
    QUEUE_ADMISSION_AUTOMATION_ENABLED: false,
    OFFICIAL_H2H_INCREMENTAL_ENABLED: false,
    FRESHNESS_CONSUMER_PROBES_ENABLED: false,
    FRESHNESS_SLO_MODE: 'shadow',
    QUEUE_HEALTH_SNAPSHOT_INTERVAL_MS: 15_000,
    QUEUE_HEALTH_WINDOW_INTERVAL_MS: 60_000,
    QUEUE_HEALTH_SNAPSHOT_TTL_SECONDS: 180,
    QUEUE_ADMISSION_GREEN_CLEAR_MS: 5 * 60_000,
    QUEUE_ADMISSION_GATE_TTL_SECONDS: 900,
    ...
    LIVE_POLL_MS: 30_000,
    PICKS_FIRST_PROBE_OFFSET_MS: 1_000,
    ...
    PRE_DEADLINE_SLOW_POLL_MS: 15 * 60_000,
    PRE_DEADLINE_WARM_POLL_MS: 2 * 60_000,
    PRE_DEADLINE_NEAR_POLL_MS: 30_000,
    GW_REVIEW_POLL_MS: 60 * 60_000,
    GW_REVIEW_FINALIZATION_POLL_MS: 15 * 60_000,
