-- Complete Database Schema for FPL Data Sync Service
-- Fixes applied: RLS disabled, syntax errors corrected, foreign keys added
...
CREATE TABLE IF NOT EXISTS "phases" (
    ...
    CONSTRAINT fk_phases_start_event FOREIGN KEY (start_event) REFERENCES events(id),
    CONSTRAINT fk_phases_stop_event FOREIGN KEY (stop_event) REFERENCES events(id)
);
...
CREATE TABLE IF NOT EXISTS "teams" (
    ...
    "pulse_id" INTEGER UNIQUE NOT NULL,
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS "player_values" (
    ...
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_player_values_element FOREIGN KEY (element_id) REFERENCES players(id) ON DELETE CASCADE,
    CONSTRAINT fk_player_values_event FOREIGN KEY (event_id) REFERENCES events(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "player_value_tracks" (
    ...
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_player_value_tracks_element FOREIGN KEY (element_id) REFERENCES players(id) ON DELETE CASCADE,
    CONSTRAINT fk_player_value_tracks_event FOREIGN KEY (event_id) REFERENCES events(id) ON DELETE CASCADE,
    CONSTRAINT fk_player_value_tracks_team FOREIGN KEY (team_id) REFERENCES teams(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "player_stats" (
    ...
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_player_stats_event FOREIGN KEY (event_id) REFERENCES events(id) ON DELETE CASCADE,
    CONSTRAINT fk_player_stats_element FOREIGN KEY (element_id) REFERENCES players(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "event_fixtures" (
    ...
    "team_a_score" INTEGER,
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_event_fixtures_event FOREIGN KEY (event_id) REFERENCES events(id) ON DELETE CASCADE,
    CONSTRAINT fk_event_fixtures_team_h FOREIGN KEY (team_h_id) REFERENCES teams(id) ON DELETE SET NULL,
    CONSTRAINT fk_event_fixtures_team_a FOREIGN KEY (team_a_id) REFERENCES teams(id) ON DELETE SET NULL
);

CREATE INDEX IF NOT EXISTS "idx_event_fixtures_event_id" ON "event_fixtures" ("event_id");
CREATE INDEX IF NOT EXISTS "idx_event_fixtures_team_h_id" ON "event_fixtures" ("team_h_id");
CREATE INDEX IF NOT EXISTS "idx_event_fixtures_team_a_id" ON "event_fixtures" ("team_a_id");
...
CREATE TABLE IF NOT EXISTS "event_lives" (
    ...
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_event_lives_event FOREIGN KEY (event_id) REFERENCES events(id) ON DELETE CASCADE,
    CONSTRAINT fk_event_lives_element FOREIGN KEY (element_id) REFERENCES players(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "event_live_explains" (
    ...
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_event_live_explains_event FOREIGN KEY (event_id) REFERENCES events(id) ON DELETE CASCADE,
    CONSTRAINT fk_event_live_explains_element FOREIGN KEY (element_id) REFERENCES players(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "entry_infos" (
    ...
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_entry_infos_started_event FOREIGN KEY (started_event) REFERENCES events(id) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS "entry_league_infos" (
    ...
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_entry_league_infos_entry FOREIGN KEY (entry_id) REFERENCES entry_infos(id) ON DELETE CASCADE,
    CONSTRAINT fk_entry_league_infos_started_event FOREIGN KEY (started_event) REFERENCES events(id) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS "entry_history_infos" (
    ...
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_entry_history_infos_entry FOREIGN KEY (entry_id) REFERENCES entry_infos(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "entry_event_picks" (
    ...
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_entry_event_picks_entry FOREIGN KEY (entry_id) REFERENCES entry_infos(id) ON DELETE CASCADE,
    CONSTRAINT fk_entry_event_picks_event FOREIGN KEY (event_id) REFERENCES events(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "entry_event_transfers" (
    ...
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_entry_event_transfers_entry FOREIGN KEY (entry_id) REFERENCES entry_infos(id) ON DELETE CASCADE,
    CONSTRAINT fk_entry_event_transfers_event FOREIGN KEY (event_id) REFERENCES events(id) ON DELETE CASCADE,
    CONSTRAINT fk_entry_event_transfers_element_in FOREIGN KEY (element_in_id) REFERENCES players(id) ON DELETE SET NULL,
    CONSTRAINT fk_entry_event_transfers_element_out FOREIGN KEY (element_out_id) REFERENCES players(id) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS "entry_event_results" (
    ...
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_entry_event_results_entry FOREIGN KEY (entry_id) REFERENCES entry_infos(id) ON DELETE CASCADE,
    CONSTRAINT fk_entry_event_results_event FOREIGN KEY (event_id) REFERENCES events(id) ON DELETE CASCADE,
    CONSTRAINT fk_entry_event_results_played_captain FOREIGN KEY (event_played_captain) REFERENCES players(id) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS "tournament_infos" (
    ...
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_tournament_infos_admin_entry FOREIGN KEY (admin_entry_id) REFERENCES entry_infos(id) ON DELETE CASCADE,
    CONSTRAINT fk_tournament_infos_group_started_event FOREIGN KEY (group_started_event_id) REFERENCES events(id) ON DELETE SET NULL,
    CONSTRAINT fk_tournament_infos_group_ended_event FOREIGN KEY (group_ended_event_id) REFERENCES events(id) ON DELETE SET NULL,
    CONSTRAINT fk_tournament_infos_knockout_started_event FOREIGN KEY (knockout_started_event_id) REFERENCES events(id) ON DELETE SET NULL,
    CONSTRAINT fk_tournament_infos_knockout_ended_event FOREIGN KEY (knockout_ended_event_id) REFERENCES events(id) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS "tournament_entries" (
    ...
    "entry_id" INTEGER NOT NULL,
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_tournament_entries_tournament FOREIGN KEY (tournament_id) REFERENCES tournament_infos(id) ON DELETE CASCADE,
    CONSTRAINT fk_tournament_entries_entry FOREIGN KEY (entry_id) REFERENCES entry_infos(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "tournament_groups" (
    ...
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_tournament_groups_tournament FOREIGN KEY (tournament_id) REFERENCES tournament_infos(id) ON DELETE CASCADE,
    CONSTRAINT fk_tournament_groups_entry FOREIGN KEY (entry_id) REFERENCES entry_infos(id) ON DELETE CASCADE,
    CONSTRAINT fk_tournament_groups_started_event FOREIGN KEY (started_event_id) REFERENCES events(id) ON DELETE SET NULL,
    CONSTRAINT fk_tournament_groups_ended_event FOREIGN KEY (ended_event_id) REFERENCES events(id) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS "tournament_points_group_results" (
    ...
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_tournament_points_group_results_tournament FOREIGN KEY (tournament_id) REFERENCES tournament_infos(id) ON DELETE CASCADE,
    CONSTRAINT fk_tournament_points_group_results_event FOREIGN KEY (event_id) REFERENCES events(id) ON DELETE CASCADE,
    CONSTRAINT fk_tournament_points_group_results_entry FOREIGN KEY (entry_id) REFERENCES entry_infos(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "tournament_battle_group_results" (
    ...
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_tournament_battle_group_results_tournament FOREIGN KEY (tournament_id) REFERENCES tournament_infos(id) ON DELETE CASCADE,
    CONSTRAINT fk_tournament_battle_group_results_event FOREIGN KEY (event_id) REFERENCES events(id) ON DELETE CASCADE,
    CONSTRAINT fk_tournament_battle_group_results_home_entry FOREIGN KEY (home_entry_id) REFERENCES entry_infos(id) ON DELETE CASCADE,
    CONSTRAINT fk_tournament_battle_group_results_away_entry FOREIGN KEY (away_entry_id) REFERENCES entry_infos(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "tournament_knockouts" (
    ...
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_tournament_knockouts_tournament FOREIGN KEY (tournament_id) REFERENCES tournament_infos(id) ON DELETE CASCADE,
    CONSTRAINT fk_tournament_knockouts_started_event FOREIGN KEY (started_event_id) REFERENCES events(id) ON DELETE SET NULL,
    CONSTRAINT fk_tournament_knockouts_ended_event FOREIGN KEY (ended_event_id) REFERENCES events(id) ON DELETE SET NULL,
    CONSTRAINT fk_tournament_knockouts_home_entry FOREIGN KEY (home_entry_id) REFERENCES entry_infos(id) ON DELETE SET NULL,
    CONSTRAINT fk_tournament_knockouts_away_entry FOREIGN KEY (away_entry_id) REFERENCES entry_infos(id) ON DELETE SET NULL,
    CONSTRAINT fk_tournament_knockouts_round_winner FOREIGN KEY (round_winner) REFERENCES entry_infos(id) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS "tournament_knockout_results" (
    ...
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_tournament_knockout_results_tournament FOREIGN KEY (tournament_id) REFERENCES tournament_infos(id) ON DELETE CASCADE,
    CONSTRAINT fk_tournament_knockout_results_event FOREIGN KEY (event_id) REFERENCES events(id) ON DELETE CASCADE,
    CONSTRAINT fk_tournament_knockout_results_home_entry FOREIGN KEY (home_entry_id) REFERENCES entry_infos(id) ON DELETE SET NULL,
    CONSTRAINT fk_tournament_knockout_results_away_entry FOREIGN KEY (away_entry_id) REFERENCES entry_infos(id) ON DELETE SET NULL,
    CONSTRAINT fk_tournament_knockout_results_match_winner FOREIGN KEY (match_winner) REFERENCES entry_infos(id) ON DELETE SET NULL
);
...
-- Core query indexes
CREATE INDEX IF NOT EXISTS idx_events_current ON events(is_current) WHERE is_current = true;
CREATE INDEX IF NOT EXISTS idx_events_next ON events(is_next) WHERE is_next = true;
CREATE INDEX IF NOT EXISTS idx_events_deadline ON events(deadline_time);
CREATE INDEX IF NOT EXISTS idx_players_team_id ON players(team_id);
CREATE INDEX IF NOT EXISTS idx_players_type ON players(type);
CREATE INDEX IF NOT EXISTS idx_teams_pulse_id ON teams(pulse_id);
CREATE INDEX IF NOT EXISTS idx_teams_strength ON teams(strength);
...
COMMENT ON DATABASE letletme_data IS 'Fantasy Premier League data synchronization database';
COMMENT ON TABLE events IS 'FPL gameweeks and events';
COMMENT ON TABLE teams IS 'Premier League teams';
COMMENT ON TABLE players IS 'FPL players/elements';
COMMENT ON TABLE player_stats IS 'Player performance statistics per event';
COMMENT ON TABLE event_fixtures IS 'Fixtures and match results';

-- Schema initialization complete
-- RLS disabled for data sync service use case
-- All foreign key constraints added for data integrity
